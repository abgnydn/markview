...
const KIND_CFG: Record<Exclude<ParticleKind, 'none'>, KindConfig> = {
  petals: {
    speedMin: 0.3, speedMax: 0.9,
    sizeMin: 6, sizeMax: 12,
    spin: 0.06,
    lifeMin: 800, lifeMax: 1600,
    driftX: 0.4, driftY: 0.6,
  ...
  snow: {
    ...
    driftX: 0.05, driftY: 0.55,
    cursorRadius: 110, cursorForce: 1.2,
    initialAngle: (r) => Math.PI * 0.45 + r * 0.1,
    hue: () => 210,
  },
  spray: {
    speedMin: 1.0, speedMax: 2.4,
    sizeMin: 2, sizeMax: 5,
    spin: 0.0,
    lifeMin: 110, lifeMax: 240,
    driftX: 0, driftY: -1.4,
