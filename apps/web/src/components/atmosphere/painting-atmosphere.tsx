...
function petalsField(rng: () => number): ParticleInstance[] {
  return Array.from({ length: 14 }, (_, i) => ({
    ...
    style: {
      left: `${rng() * 100}%`,
      animationDelay: `${-rng() * 18}s`,
      animationDuration: `${14 + rng() * 14}s`,
  ...
  return Array.from({ length: 36 }, (_, i) => {
    ...
    return {
      ...
      style: {
        ...
        width: `${size}px`,
        height: `${size}px`,
        animationDelay: `${-rng() * 22}s`,
        animationDuration: `${12 + rng() * 14}s`,
...
function sprayField(rng: () => number): ParticleInstance[] {
  return Array.from({ length: 22 }, (_, i) => ({
    ...
    style: {
      ...
      animationDuration: `${2.4 + rng() * 2.6}s`,
  ...
  return Array.from({ length: 16 }, (_, i) => {
    ...
    return {
      ...
      style: {
        ...
        width: `${size}px`,
        height: `${size}px`,
        animationDelay: `${-rng() * 24}s`,
        animationDuration: `${18 + rng() * 16}s`,
