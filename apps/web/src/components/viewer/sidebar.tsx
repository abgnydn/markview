...
// as an <AtmosphereControls /> footer. They moved to the floating
// AtmosphereDots component (bottom-left of the viewport) so the
// sidebar stays a focused file-list surface. See
// components/atmosphere/atmosphere-dots.tsx.
