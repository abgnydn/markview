...
export const ATMOSPHERES: Record<Exclude<Atmosphere, 'none'>, AtmosphereConfig> = {
  fuji: {
    ...
    paintings: [
      {
        key: 'red-fuji',
        imageSrc: '/atmospheres/fuji-hokusai.webp',
      ...
      {
        key: 'storm-below',
        imageSrc: '/atmospheres/fuji-36492.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'noboto-bay',
        imageSrc: '/atmospheres/fuji-56216.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'lake-suwa',
        imageSrc: '/atmospheres/fuji-56240.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'fujimigahara',
        imageSrc: '/atmospheres/fuji-56214.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'ushibori',
        imageSrc: '/atmospheres/fuji-56132.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'nakahara',
        imageSrc: '/atmospheres/fuji-56384.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'shichirigahama',
        imageSrc: '/atmospheres/fuji-36496.webp',
        attribution: 'Katsushika Hokusai',
  ...
  wave: {
    ...
    paintings: [
      {
        key: 'great-wave',
        imageSrc: '/atmospheres/wave-hokusai.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'umezawa-manor',
        imageSrc: '/atmospheres/wave-36501.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'kazusa-sea',
        imageSrc: '/atmospheres/wave-56238.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'yahagi-bridge',
        imageSrc: '/atmospheres/wave-53700.webp',
        attribution: 'Katsushika Hokusai',
      ...
      {
        key: 'calm-sea',
        imageSrc: '/atmospheres/wave-436005.webp',
      ...
      {
        key: 'la-vague',
        imageSrc: '/atmospheres/wave-399926.webp',
      ...
      },
      {
        ...
        imageSrc: '/atmospheres/wave-383817.webp',
  ...
  snow: {
    ...
    paintings: [
      ...
      {
        key: 'evening-snow',
        imageSrc: '/atmospheres/snow-57044.webp',
        attribution: 'Utagawa Hiroshige',
      ...
      },
      {
        ...
        imageSrc: '/atmospheres/snow-55628.webp',
        attribution: 'Utagawa Hiroshige',
      ...
      {
        key: 'uchikawa-snow',
        imageSrc: '/atmospheres/snow-56890.webp',
        attribution: 'Utagawa Hiroshige',
      ...
      },
      {
        ...
        imageSrc: '/atmospheres/snow-55604.webp',
        attribution: 'Utagawa Hiroshige',
      ...
      },
      {
        ...
        imageSrc: '/atmospheres/snow-55998.webp',
        attribution: 'Utagawa Hiroshige',
      ...
      {
        key: 'bamboo-in-snow',
        imageSrc: '/atmospheres/snow-49068.webp',
      ...
      },
      {
        ...
        imageSrc: '/atmospheres/snow-438816.webp',
    ...
    paintings: [
      {
        ...
        imageSrc: '/atmospheres/fields-vangogh.webp',
      ...
      {
        key: 'cypresses',
        imageSrc: '/atmospheres/fields-437980.webp',
        attribution: 'Vincent van Gogh',
      ...
      {
        key: 'olive-trees',
        imageSrc: '/atmospheres/fields-437998.webp',
        attribution: 'Vincent van Gogh',
      ...
      {
        key: 'wheat-field',
        imageSrc: '/atmospheres/fields-335537.webp',
        attribution: 'Vincent van Gogh',
      ...
      {
        key: 'the-harvesters',
        imageSrc: '/atmospheres/fields-435809.webp',
