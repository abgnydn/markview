...
- **feat**: feat(viewer): cards mode — H2 sections become swipeable cards — [`98a0e1c`](https://github.com/abgnydn/markview/commit/98a0e1cd6d98ecaee2d7fce7c3f6904e3d9130c6)
- **feat**: feat(viewer): margin footnotes + constellation mode in graph view — [`7d4f03f`](https://github.com/abgnydn/markview/commit/7d4f03fc857bff7f95a28f4d3ddb33578905612f)
- **feat**: feat(ui): theme confirm modal + brush-stroke cursors + richer audio +… — [`24d6bcf`](https://github.com/abgnydn/markview/commit/24d6bcff1492f0a09850cf7b014fd7112bea5985)
- **fix**: fix(atmosphere): drop near-duplicate snow paintings + redesign SVG cu… — [`238f7f4`](https://github.com/abgnydn/markview/commit/238f7f40865739de6ffafa79de4b9bfa6fdb2bf0)
- **fix**: fix(ui): TOC scroll-spy + mobile sidebar blur + appearance-aware cursor — [`ec32774`](https://github.com/abgnydn/markview/commit/ec3277415bc5a094156ade3314a3f491230470bf)
